...
def process_frame(frame):
    ...
    for i in range(detecciones.shape[2]):
        ...
        if conf_detect > umbral:
            ...
            cv2.putText(frame, access_label, label_position, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
            cv2.putText(frame, recognized_name, name_position, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1)
